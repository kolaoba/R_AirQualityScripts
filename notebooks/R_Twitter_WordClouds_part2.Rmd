...
It's really easy to build and I'll the code on my [github](https://github.com/kolaoba/R_Projects/tree/main/apps/TwitterWordCloud) in case you want to reproduce for yourself. Get your twitter API access first!
