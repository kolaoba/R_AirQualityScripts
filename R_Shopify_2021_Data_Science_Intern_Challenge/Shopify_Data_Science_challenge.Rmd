...
Quick look at the dataset by summarizing our data
...
Response: This calculation tries to evaluate the AOV across all 100 shops over the 30 day window. This results in the high $3145.13 value. 

According to [this definition](https://www.shopify.com.ng/blog/average-order-value#averageorder), to obtain the AOV, we divide the total revenue by the total number of orders. Doing this for each shop and getting the average, we have 
